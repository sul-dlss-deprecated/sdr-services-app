...
module Sdr
  ...
  class ServicesAPI < Sdr::Base
    ...
    GENERIC_DEPR_MSG = 'sdr-services-app is deprecated; please use preservation-catalog API and preservation-client gem instead'
    ...
    get '/doc' do
      Deprecation.warn(nil, GENERIC_DEPR_MSG)
      Honeybadger.notify(GENERIC_DEPR_MSG)
