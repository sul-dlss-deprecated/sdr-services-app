...
module Sdr
  ...
  #
  # https://github.com/sul-dlss/sdr-services-app
  #
  class ServicesApi < Sinatra::Base
    ...
    # @note Displays DRUID links menu (HTML)
    ...
    # @param [Integer] version DRUID version number
    # @return [String] a list of DRUID files (by category and version; HTML)
    ...
    # @raise [Moab::FileNotFoundException] if a DRUID file doesn't exist
